...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_TERRASILENT)
extern struct cpufreq_governor cpufreq_gov_terrasilent;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_terrasilent)
#endif
